OLD_NAME = "neural_network_policy_name"
RUN_NAME = "neural_network_policy_name_cont"
...
for i in 1:NUM_TIME_INTERVAL
    model_state = JLD2.load("logs_" * OLD_NAME * "/z$i.jld2", "model_state")
    Flux.loadmodel!(DeepNN_z[i], model_state)
end

model_state = JLD2.load("logs_" * OLD_NAME * "/y.jld2", "model_state")
Flux.loadmodel!(DeepNN_y, model_state)
...
@load "logs_" * OLD_NAME * "/final_optimizer.jld2" optimizer
