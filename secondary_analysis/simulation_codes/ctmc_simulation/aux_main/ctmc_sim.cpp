...
namespace simulation {
	...
	int Simulation::save(){
		...
		for (int k = 0; k < 625; k++){
			...
			std::string file_name_pol = "/home/ekasikar/ctmc_simulation/aux_main/policy" + std::to_string(k) + ".csv";
	...
	void Execute::optimal_policy_calculation(std::vector<float>& optimal_policy_matrix){
			...
			if (index[1] == "c_mu"){
				low_priority_group1 = {12, 14, 15, 16};
			} else if (index[1] == "cost"){
				low_priority_group1 = {12, 14, 15, 16};
			} else if (index[1] == "c_mu_theta"){
				low_priority_group1 = {14, 16, 12, 15};
			} else if (index[1] == "c_mu_theta_diff"){
				low_priority_group1 = {14, 16, 15, 12};
			...
			if (index[2] == "c_mu"){
				low_priority_group2 = {3, 13, 10, 7};
			} else if (index[2] == "cost"){
				low_priority_group2 = {3, 13, 7, 10};
			} else if (index[2] == "c_mu_theta"){
				low_priority_group2 = {3, 7, 13, 10};
			} else if (index[2] == "c_mu_theta_diff"){
				low_priority_group2 = {3, 10, 7, 3};
			} else if (index[2] == "mu_theta_diff"){
				low_priority_group2 = {10, 13, 7, 3};
			}

			// low priority group 3
			if (index[3] == "c_mu"){
				low_priority_group3 = {9, 11, 8};
			} else if (index[3] == "cost"){
				low_priority_group3 = {9, 11, 8};
			} else if (index[3] == "c_mu_theta"){
				low_priority_group3 = {9, 8, 11};
			} else if (index[3] == "c_mu_theta_diff"){
				low_priority_group3 = {8, 9, 11};
			} else if (index[3] == "mu_theta_diff"){
				low_priority_group3 = {8, 11, 9};
			}
...
int main(int argc, char** argv){ 
	...
	std::string jsonFileName = "/home/ekasikar/ctmc_simulation/aux_main/config_main/config_main.json"; //the configuration file to initialize the simulation
