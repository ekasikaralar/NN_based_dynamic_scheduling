...
namespace simulation {
	...
	int Simulation::save(){
		...
		for (int k = 0; k < 625; k++){
			...
			std::string file_name_pol = "/var1_test_auxiliary_mdp/policy" + std::to_string(k) + ".csv";
...
int main(int argc, char** argv){ 
	...
	std::string jsonFileName = "/var1_test_auxiliary_mdp/config_var1.json"; //the configuration file to initialize the simulation
