...
namespace simulation {
	...
	int Simulation::save(){
		...
		for (int k = 0; k < 625; k++){
			...
			std::string file_name_pol = "/home/ekasikar/ctmc_simulation/aux_var1/policy" + std::to_string(k) + ".csv";
...
int main(int argc, char** argv){ 
	...
	std::string jsonFileName = "/home/ekasikar/ctmc_simulation/aux_var1/config_var1/config_var1.json"; //the configuration file to initialize the simulation
