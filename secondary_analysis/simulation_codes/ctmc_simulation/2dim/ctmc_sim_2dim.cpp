...
int main(int argc, char** argv){ 
	...
	std::string jsonFileName = "/project/Call_Center_Control/analyses_final/ctmc_benchmarks/2dim/config_2dim.json"; //the configuration file to initialize the simulation
