...
namespace simulation {
    ...
    int Simulation::save(){
        ...
        for (int k = 0; k < 125; k++){
            ...
            std::string file_name_pol = "/home/ekasikar/extended_benchmark_simulations/var2/static_benchmarks_beta_alpha/policy" + std::to_string(k) + ".csv";
...
int main(int argc, char** argv){ 
	...
	std::string jsonFileName = "/home/ekasikar/extended_benchmark_simulations/var2/config_var2/config_var2.json"; //the configuration file to initialize the simulation
