...
namespace simulation {
    ...
    int Simulation::save(){
        ...
        for (int k = 0; k < 125; k++){
            ...
            std::string file_name_pol = "/home/ekasikar/var1_test_problem_benchmarks/static_benchmarks_alpha_beta/test_policy" + std::to_string(k) + ".csv";
...
int main(int argc, char** argv){ 
	...
	std::string jsonFileName = "/home/ekasikar/var1_test_problem_benchmarks/static_benchmarks_alpha_beta/config_var1.json"; //the configuration file to initialize the simulation
